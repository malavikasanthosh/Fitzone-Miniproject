        ...
        <div class="row gx-3">
            <div class="col-12">
                <div class="d-flex flex-column">
                    <p class="text mb-1">Person Name</p> <input class="form-control mb-3" type="text" placeholder="Name" value="{{$myPackage->member->name}}">
                </div>
            </div>
            <div class="col-12">
                <div class="d-flex flex-column">
            ...
            <div class="col-12">
                <button wire:click="payment" class="btn btn-primary mb-3"> <span class="ps-3">Pay Rs.{{$myPackage->package->amount}}</span> <span class="fas fa-arrow-right"></span> </button>
            </div>
        </div>
    </div>
</div>
